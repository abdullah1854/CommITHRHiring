  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className={cn(
        ...
        transparent ? "bg-transparent" : "bg-card border-b border-slate-200 shadow-sm"
      )}>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className={cn(
                ...
                transparent ? "bg-background/10 text-white hover:bg-background/20" : "bg-slate-100 text-slate-700 hover:bg-slate-200",
              )}
            >
            ...
            {user ? (
              ...
              <Link href="/login" className={cn(
                ...
                transparent 
                  ? "bg-background/10 text-white hover:bg-background/20 backdrop-blur-md" 
